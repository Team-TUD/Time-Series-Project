...
from metrics.visualization_metrics import plot_loss
...
def main (args):
    ...
    visualization(data, generated, 'pca',
                  args.model + '-' + args.data_name + '-' + str(args.iteration_supervised) + 'superviseditt-' + str(
                      args.iteration_joint) + 'jointitt')
    ...
    with open('results/metrics/' + args.model + '-' + args.data_name + '-' + str(
            args.iteration_supervised) + 'superviseditt-' + str(args.iteration_joint) + 'jointitt-metrics.json',
              'w') as json_file:
        json.dump(metric_results, json_file, cls=NumpyEncoder)

    with open('results/metrics/' + args.model + '-' + args.data_name + '-' + str(
            args.iteration_supervised) + 'superviseditt-' + str(args.iteration_joint) + 'jointitt-time-metrics.json',
              'w') as json_file:
